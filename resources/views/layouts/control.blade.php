...
<body class="g-sidenav-show rtl bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret ps ps__rtl ps--active-y bg-white" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        <img src="@if(Auth::user()->image == null){{asset('assets/img/placeholder.png')}}@else{{asset('storage/'.Auth::user()->image)}}@endif" class="circle-img" alt="main_logo">
    ...
    <div class="collapse navbar-collapse px-0 w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link " href="{{url('/control/users')}}">
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{url('/control/services')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{url('/control/pcrs')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
              <span class="fas fa-thermometer-half"></span>
            </div>
            <span class="nav-link-text me-1">حجوزات Pcr</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="{{url('/control/serviceRequests')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
              <span class="fas fa-suitcase"></span>
            </div>
            <span class="nav-link-text me-1">طلبات الخدمات</span>
          </a>
        </li>
        
        <li class="nav-item">
          <a class="nav-link " href="{{url('/control/car')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
              <span class="fas fa-car"></span>
            </div>
            <span class="nav-link-text me-1">طلبات النقل</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="{{url('/control/chat')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{url('/control/categories')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
              <span class="fas fa-shopping-cart"></span>
            </div>
            <span class="nav-link-text me-1">تصنيفات المتاجر</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="{{url('/control/stores')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
              <span class="fas fa-shopping-cart"></span>
            </div>
            <span class="nav-link-text me-1"> المتاجر</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="{{url('/control/products')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
